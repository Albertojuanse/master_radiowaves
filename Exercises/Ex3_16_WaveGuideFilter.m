...
% Sustituir los inversores por irises en la guía de onda, es decir,
% calcular las dimensiones de las anchuras de los irises que sintetizan los
% inversores del diseño. Conrregir las longitudes de las cavidades teniendo
% en cuenta la corrección de fase de los inversores cuando se implementan
% con los irises.
...
phi1 = 0.4950; Kn1=0.4523; w1=11.8680;
phi2 = 0.2187; Kn2=0.1663; w2=8.5680;
phi3 = 0.1761; Kn3=0.1159; w3=7.8640;
phi4 = 0.2187; Kn4=0.1159; w4=8.5680;
phi5 = 0.4950; Kn5=0.1663; w5=11.8680;

theta0 = beta_freq_cen * lambda0/2;
Ln1 = (lambda0/(2*pi))*(theta0 - phi1 - phi2);
Ln2 = (lambda0/(2*pi))*(theta0 - phi2 - phi3);
Ln3 = (lambda0/(2*pi))*(theta0 - phi3 - phi4);
Ln4 = (lambda0/(2*pi))*(theta0 - phi4 - phi5);
% Ln5 = (lambda0/(2*pi))*(theta0 - phi5 - phi6);

%EL EJERCICIO 17 ES EJECUTAR EL EJEMPLO 1 DEL pp_CalculaMM, con los valores
%obtenidos
...
ABCDK1 = ABCDofInversor(Kn1);
ABCDK2 = ABCDofInversor(Kn2);
ABCDK3 = ABCDofInversor(Kn3);
ABCDK4 = ABCDofInversor(Kn4);
ABCDK5 = ABCDofInversor(Kn5);
% ABCDK6 = ABCDofInversor(Kn6);

for i_pulsation = 1:samples

    ABCD_LT1 = ABCDofLine(Zc, beta(i_pulsation), Ln1);
    ABCD_LT2 = ABCDofLine(Zc, beta(i_pulsation), Ln2);
    ABCD_LT3 = ABCDofLine(Zc, beta(i_pulsation), Ln3);
    ABCD_LT4 = ABCDofLine(Zc, beta(i_pulsation), Ln4);
%     ABCD_LT5 = ABCDofLine(Zc, beta(i_pulsation), Ln5);
