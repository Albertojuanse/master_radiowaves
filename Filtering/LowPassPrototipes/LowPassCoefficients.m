function [vg,gL,textodis]= LowPassCoefficients(tipodis,varargin)
%=====================================================
% © All rights reserved by
%       jorge.ruizcruz@uam.es
%       2014/12/04 12:00:00
%   Provided to students as master course's material.
%   Any other use is not authorised.
%=====================================================
...
% tipodis: string con el tipo de dise�o que se quiere
% N: orden
% rip: equirrizado
% vg: elementos del prototipo paso bajo
% gL: carga normalizada
% textodis: string con un identificador del dise�o y sus par�metros
%
% DESCRIPCI�N:
% Dado un identificador de tipo de idse�o y sus par�metros correpondientes
% (tipicamente el orden y las perdidas de retorno m�ximas) se calculan los
...
%==============================================    
case 'Bessel'
% retardo de grupo maximalmente plano: Tabla 8.5, pag. 454, Collin (tambi�n en Mattaei)    
%==============================================
